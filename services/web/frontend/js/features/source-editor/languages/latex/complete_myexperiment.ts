...
const dummyBibtexEntries = [
  { label: 'cho2024gaussiantalker; Gaussiantalker: Real-time talking head synthesis with 3d gaussian splatting', type: 'bibtex', apply: 'cho2024gaussiantalker' },
  { label: 'chung2017out', type: 'bibtex', apply: 'chung2017out'},
]
...
export const bibKeyArgumentCompletionSource: CompletionSource =
  makeMultipleArgumentCompletionSource(
    ...
    ({ completions, context, from, validFor, existingKeys }) => {
      // completions.references.push(...dummyBibtexEntries)
